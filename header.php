                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 hidden-xs-down">
                        <div class="topsocial">
                            ...
                            <a href="login.php" data-toggle="tooltip" data-placement="bottom" title="login">login</a>
                            
                            <a href="logout.php" data-toggle="tooltip" data-placement="bottom" title="logout">logout</a>
                        </div><!-- end social -->
                    </div><!-- end col -->
